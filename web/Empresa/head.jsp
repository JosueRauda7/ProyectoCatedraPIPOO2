<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  	<!-- core CSS -->
...
<link href="${pageContext.request.contextPath}/css/fileinput.min.css" rel="stylesheet" type="text/css"/>
<script src="${pageContext.request.contextPath}/js/jquery-1.12.0.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/js/fileinput.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/js/es.js" type="text/javascript"></script>

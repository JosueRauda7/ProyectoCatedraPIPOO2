        ...
        <jsp:include page="/Empresa/MenuEmpresa.jsp"></jsp:include>
            <section>
                <div class="panel panel-default col-lg-6 col-sm-offset-3" style="margin-top: 5%; margin-bottom: 5%;" >
                    <div class="row" >
                        <div class="thumbnail">
                            <h2 style="color:#c2185b;">Modificar Empleado</h2>
                        </div>
                    ...
                    <form action="${base}/usuarios.do" method="POST" style="padding: 5%;">
                        ...
                        <input type="hidden" name="operacion" value="modificarE"/>
                        <div class="col-md-12" style="padding-bottom: 3%;">
                            ...
                            <button type="submit" class="btn" style="background-color: #c2185b">Modificar</button>
